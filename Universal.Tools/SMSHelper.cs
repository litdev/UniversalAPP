...
namespace UniversalAPP.Tools
{
    ...
    public class SMSHelper
    {
        ...
        private const string SignName = "朗形试镜";
        ...
        /// <returns></returns>
        public static string SendSms(string mobile, string code, string templateCode = "SMS_142055271")
        {
            if (!ValidateHelper.IsMobile(mobile)) return "非法手机号";
        ...
        {
            MessageModel message = JsonHelper.ToObject<MessageModel>(str);
            string result = "";
            switch (message.Code)
            {
                case "OK":
