...
namespace UniversalAPP.Web
{
    ...
    public class PromptModel
    {
        ...
        public PromptModel(string message, string details)
        {
            // _status = status;
            _details = details;
            _message = message;
        ...
        /// <param name="message"></param>
        /// <param name="details"></param>
        public PromptModel(string linkUrl, string message, string details)
        {
            _linkurl = linkUrl;
            _details = details;
            //_status = status;
        ...
        public PromptModel(string linkUrl, string message, string details, int time)
        {
            _linkurl = linkUrl;
            _details = details;
            //_status = status;
